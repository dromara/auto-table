...
public class ColumnSqlBuilder {
    ...
    public static String buildSql(ColumnMetadata columnMetadata) {
        ...
        if (columnMetadata.isAutoIncrement()) {
            ...
            PropertyConfig.PgsqlConfig.PgsqlPkAutoIncrementType pkAutoIncrementType = AutoTableGlobalConfig.instance().getAutoTableProperties().getPgsql().getPkAutoIncrementType();
