...
### 🔌 多数据库支持
- **关系型数据库**：MySQL、PostgreSQL、SQL Server、Oracle、SQLite、H2
- **国产数据库**：达梦、人大金仓、YashanDB
- **分析型数据库**：Doris
...
| SQL Server | 2016+ | ✅ 稳定 | [@tangzc](https://gitee.com/tangzc) |
...
| YashanDB | 23.4.7.100 / JDBC 1.10.8 | ✅ 稳定 | [@Assassin-Q](https://gitee.com/qianguanshui) |
