...
v2.6.2 由于 Sonatype Central Publishing 插件限制，未能成功发布 `auto-table-adapter` 相关模块，导致 MyBatis-Plus 和 MyBatis-Flex 集成能力缺失。

**本次版本补发以下构件：**
- `auto-table-adapter-mybatis-plus`
- `auto-table-adapter-mybatis-flex`
- `auto-table-adapter-mybatis-plus-spring-boot-starter`
- `auto-table-adapter-mybatis-flex-spring-boot-starter`
